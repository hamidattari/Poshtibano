// Updated MediaPermissionRequestForm.Designer.cs
namespace Poshtibano.Desk.Forms
{
    partial class MediaPermissionRequestForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelTitle.Size = new Size(259, 28);
            labelTitle.TabIndex = 0;
            labelTitle.Text = "🔊📺 درخواست مجوز رسانه ";
            ...
            labelMessage.Text = "یک کاربر درخواست دسترسی به رسانه شما را فرستاده است.\n\nآیا اجازه می‌دهید؟";
            // 
            // labelRequester
            // 
            ...
            panelInfo.Location = new Point(45, 163);
            panelInfo.Name = "panelInfo";
            panelInfo.RightToLeft = RightToLeft.Yes;
            panelInfo.Size = new Size(399, 106);
            ...
            labelInfo.Location = new Point(89, 7);
            labelInfo.Name = "labelInfo";
            labelInfo.Size = new Size(303, 90);
            labelInfo.TabIndex = 0;
            labelInfo.Text = "⚠️ اگر اجازه دهید، این کاربر می‌تواند:\n\n  • به رسانه شما (صدا/وبکم) دسترسی پیدا کند";
            // 
            // MediaPermissionRequestForm
            // 
            ...
            Name = "MediaPermissionRequestForm";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "درخواست مجوز رسانه";
            TopMost = true;
