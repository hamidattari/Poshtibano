...
{
    public partial class InvitationRequestForm : Form
    {
        ...
        public InvitationRequestForm(string requesterName)
        {
            InitializeComponent();
            labelRequester.Text = $"📱 {requesterName}";
