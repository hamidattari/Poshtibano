...
{
    partial class InvitationRequestForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelMessage.Text = "یک کاربر از راه دور درخواست دسترسی به دسکتاپ خود را برای شما را فرستاده است.\r\n\r\nآیا اجازه می‌دهید؟";
            // 
            // labelRequester
            // 
            ...
            labelInfo.Text = "⚠️ اگر اجازه دهید، شما می‌تواند:\r\n\r\n  • صفحه نمایش  کاربر را ببیند\r\n  • موس و کیبورد کاربر را کنترل کنید";
            // 
